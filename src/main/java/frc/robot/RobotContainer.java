...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    final JoystickButton xPattern =
        new JoystickButton(driverRightJoystick, 8); // TODO: Remove this if not necessary -Sean
    final JoystickButton lockToZero =
        new JoystickButton(driverRightJoystick, 9); // TODO: Remove this if not necessary -Sean
