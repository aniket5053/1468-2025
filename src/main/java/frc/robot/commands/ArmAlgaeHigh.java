...
public class ArmAlgaeHigh extends SequentialCommandGroup {
  ...
  public ArmAlgaeHigh(ElevatorSubsystem elevator, ElbowSubsystem elbow, WristSubsystem wrist) {
    addCommands(
        Commands.parallel(
            ...
            Commands.sequence(
                ...
                new MM_ElevatorToPosition(
                    elevator, ElevatorConstants.kAlgaeHighPos, ElevatorConstants.kToleranceInches)),
            Commands.sequence(
                new WaitCommand(0.3),
